  ...
  return (
    <>
      <section className="hero fade-in" id="hero">
        <h2>
          Hi, I'm <span>Utkarsh Loneya</span>
        </h2>
        <p>Backend Developer | API Engineer | Database Architect</p>
        <a href="#projects">
      ...
      <section className="projects fade-in" id="projects">
        ...
        <div className="project-grid">
          <div className="project-card">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQR7DeRThRyccykmpWBmx5ENwIVs1N84VgrcQ&s" />
          ...
          <div className="project-card">
            ...
            <p>
              Product catalog, payments & order management built with Express.js
              & PostgreSQL.
            </p>
          </div>
          <div className="project-card">
