export default function FrontendDeveloper(params) {
  return (
    <>
      <section className="hero">
        <div className="hero-content">
          <h2>
            Hello, I'm <span>Frontend Developer</span>
          </h2>
          <p>
            I create clean, modern and interactive web interfaces using HTML,
            CSS, and React.
          </p>
      ...
      <section id="projects" className="container projects">
        ...
        <div className="project-grid">
          <div className="project-card">
            ...
            <p>A modern personal portfolio built with HTML, CSS, and React.</p>
          </div>
          <div className="project-card">
            <img src="https://picsum.photos/400/250?2" alt="Project 2" />
            <h3>E-commerce UI</h3>
            <p>
              An interactive online shop interface with product cards and
              filters.
            </p>
          </div>
          <div className="project-card">
            ...
            <h3>Dashboard App</h3>
            <p>A responsive dashboard design with charts and analytics view.</p>
          </div>
        </div>
      </section>
